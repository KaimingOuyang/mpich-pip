...
MPL_STATIC_INLINE_PREFIX int MPID_Reduce(const void *sendbuf, void *recvbuf,
	...
	case MPIDI_Reduce_intra_composition_alpha_id: {
		// printf("call MPIDI_Reduce_intra_composition_alpha %d\n", *(int*) sendbuf);
		// fflush(stdout);
		mpi_errno =
	...
	case MPIDI_Reduce_intra_composition_beta_id: {
		// printf("call MPIDI_Reduce_intra_composition_beta\n");
		// fflush(stdout);
		mpi_errno =
	...
	case MPIDI_Reduce_inter_composition_alpha_id: {
		// printf("call MPIDI_Reduce_inter_composition_alpha\n");
		// fflush(stdout);
		mpi_errno =

                                                                 ...
                                                                 MPI_Aint data_sz, int task_kind)
{
    ...
    MPIR_Typerep_pack(src_buf, src_count, src_dt_dup, 0, itd_buffer, data_sz, &actual_bytes);
    MPIR_Assert(actual_bytes == data_sz);

    MPIR_Typerep_unpack(itd_buffer, data_sz, dest_buf, dest_count, dest_dt, 0, &actual_bytes);
    MPIR_Assert(actual_bytes == data_sz);
    free(itd_buffer);
